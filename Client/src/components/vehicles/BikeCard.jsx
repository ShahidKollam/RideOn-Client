    ...
    return (
        <article className="group overflow-hidden rounded-2xl border border-slate-100 bg-white shadow-[0_8px_28px_rgba(15,23,42,0.06)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_16px_36px_rgba(15,23,42,0.11)]">
            <div className="relative aspect-[16/10] bg-slate-50">
                ...
                <span
                    className={`absolute top-3 right-3 rounded-full px-2.5 py-1 text-[11px] font-bold ${statusStyles[vehicle.status] || statusStyles.DISABLED}`}
                >
            ...
            <div className="p-4 sm:p-5">
                ...
                <h2 className="mt-1 text-lg font-extrabold text-rideon-dark">
                ...
                <Link
                    ...
                    className="mt-5 inline-flex items-center gap-1.5 text-sm font-bold text-rideon-blue transition-transform hover:translate-x-1"
                >
