...
export const getOverview = async () => {
  ...
  const [
    totalUsers, newUsers, totalBikes, availableBikes, maintenanceBikes,
    todayBookings, activeBookings, completedBookings, cancelledBookings,
    todayRevenueAgg, pendingPayments,
  ] = await Promise.all([
    prisma.user.count(),
  ...
  return {
    ...
    bikes: { total: totalBikes, available: availableBikes, maintenance: maintenanceBikes },
    bookings: {
      today: todayBookings,
